...
Korekta skali i chodu 2026-09-13: ludzie mają 1,16 jednostki wzrostu i szkielet z oddzielnymi kolanami, kostkami oraz łokciami. Pasażerowie poruszają się energicznie, 1,5 jednostki/s przy nowym wzroście; kroki i zwrot wynikają z rzeczywistego przesunięcia. Stopa podczas podparcia stoi płasko i nie przesuwa się po tarasie. Dojście, drzwi auta, powrót i odejście używają długości swoich odcinków zamiast stałych czasów. Ten sam mechanizm animacji obsługuje Ariego. [Parametry oraz testy synchronizacji](ON_FOOT.md#synchronizacja-chodu--korekta-2026-09-13).

Korekta dymków 2026-09-13: `TaxiNoticeBubble` rysuje komunikat w każdej klatce, po kamerze i strzałce, korzystając z tej samej interpolowanej pozycji auta. Dotychczasowy dymek używał pozycji fizycznej i odświeżał się razem z HUD-em co 0,1 s, co powodowało drgania. Łamanie tekstu jest przechowywane do zmiany treści/szerokości. [Testy i korekta granic miasta](CITY_02.md#granice-i-tablice-ostrzegawcze--2026-09-13).
