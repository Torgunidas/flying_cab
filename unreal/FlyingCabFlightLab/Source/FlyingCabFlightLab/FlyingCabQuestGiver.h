...
public:
	...
	virtual FName GetQuestTargetId() const override { return NpcProfile ? NAME_None : QuestGiverId; }
	FName GetNpcId() const;
	UFlyingCabNpcDefinition* GetNpcProfile() const { return NpcProfile; }
	void ConfigureProfile(UFlyingCabNpcDefinition* Profile);

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Flying Cab|NPC")
	TObjectPtr<UFlyingCabNpcDefinition> NpcProfile;
	...
	UFlyingCabQuestDefinition* GetQuestDefinition() const;
...
private:
	...
	UPROPERTY(EditInstanceOnly, BlueprintReadOnly, AdvancedDisplay, Category = "Flying Cab|Legacy Quest Giver", meta = (AllowPrivateAccess = "true"))
